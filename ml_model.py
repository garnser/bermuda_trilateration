...
def load_ml_model():
    ...
    try:
        ...
        print("No saved ML model found. Model will be trained when needed.")
...
def train_ml_model(rssi_data):
    ...
    with model_lock:
        ...
        for persistent_id, sensor_mac, rssi, x, y, z in data:
            ...
            # Add pairwise differences between RSSI values.
        ...
        print(f"ML model trained on {len(features)} samples and saved to {MODEL_FILE}")
